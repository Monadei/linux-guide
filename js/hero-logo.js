(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // === Фаза 1: Пиксельный шум на месте текста ===
    // Создаём буквы, но они показывают случайные символы
    var chars = [];
    ...
    // Быстрая смена глитч-символов в первой фазе
    ...
    // === Фаза 2: через 600 мс — буквы слетаются на место ===
    setTimeout(function() {
      clearInterval(glitchInterval);
      
      chars.forEach(function(ch, i) {
        // Меняем символ на настоящую букву
        if (ch.dataset.real === ' ') {
          ch.textContent = '\u00A0';
        } else {
